...
public class ConvertReferenceType extends ConvertTypeMirror implements com.sun.mirror.type.ReferenceType {
	protected ConvertReferenceType(javax.lang.model.type.ReferenceType internal) {
		super(internal);
	}
}
