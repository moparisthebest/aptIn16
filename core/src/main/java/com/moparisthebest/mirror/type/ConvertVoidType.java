...
public class ConvertVoidType extends ConvertTypeMirror implements com.sun.mirror.type.VoidType {

	protected ConvertVoidType(javax.lang.model.type.NoType internalNoType) {
		super(internalNoType);
	}
