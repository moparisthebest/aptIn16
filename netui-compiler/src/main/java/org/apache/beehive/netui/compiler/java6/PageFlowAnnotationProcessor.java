...
package org.apache.beehive.netui.compiler.java6;

import com.moparisthebest.mirror.apt.ConvertAnnotationProcessorFactory;

public class PageFlowAnnotationProcessor extends ConvertAnnotationProcessorFactory {

	public PageFlowAnnotationProcessor() {
		super("org.apache.beehive.netui.compiler.apt.PageFlowAnnotationProcessorFactory");
	}
