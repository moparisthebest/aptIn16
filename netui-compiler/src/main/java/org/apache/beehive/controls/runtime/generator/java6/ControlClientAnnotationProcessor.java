...
public class ControlClientAnnotationProcessor extends ConvertAnnotationProcessorFactory {

	public ControlClientAnnotationProcessor() {
		super("org.apache.beehive.controls.runtime.generator.apt.ControlClientAnnotationProcessorFactory");
	}
