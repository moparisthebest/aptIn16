...
public class ControlSecondaryAnnotationProcessor extends ConvertAnnotationProcessorFactory {

	public ControlSecondaryAnnotationProcessor() {
		super("org.apache.beehive.controls.runtime.generator.apt.ControlSecondaryAnnotationProcessorFactory");
	}
