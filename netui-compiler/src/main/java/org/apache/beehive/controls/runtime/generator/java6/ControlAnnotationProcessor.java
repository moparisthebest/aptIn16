...
public class ControlAnnotationProcessor extends ConvertAnnotationProcessorFactory {

	public ControlAnnotationProcessor() {
		super("org.apache.beehive.controls.runtime.generator.apt.ControlAnnotationProcessorFactory");
	}
